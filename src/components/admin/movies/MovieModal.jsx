...
export default function MovieModal({
  ...
  const inputClass =
    "w-full h-[42px] px-3 rounded-lg bg-[#020617] border border-white/10 text-white placeholder-gray-500 outline-none focus:border-red-500";
      ...
      <div className="w-[620px] bg-[#0b0f1f] rounded-2xl border border-white/10">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className={labelClass}>Tên phim (VN)</label>
              <input
                value={form?.title || ""}
                onChange={(e) =>
        ...
        <div className="flex gap-4 px-6 py-5 border-t border-white/10">
          ...
          <button
            onClick={onClose}
            className="flex-1 h-[44px] bg-gray-700 hover:bg-gray-600 rounded-lg"
          >
            Hủy
          </button>

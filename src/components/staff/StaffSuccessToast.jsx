...
export default function StaffSuccessToast({ message, type = "success", onClose }) {
  ...
  return (
    <div className="fixed right-4 top-4 z-[70] transition-all duration-300">
      <div className={`flex items-center gap-2 rounded-2xl border ${currentConfig.border} ${currentConfig.bg} px-4 py-3 text-sm font-semibold ${currentConfig.text} shadow-2xl shadow-black/30 backdrop-blur`}>

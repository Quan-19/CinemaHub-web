  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          onClick={exportToCSV}
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-white/10 text-white/80 hover:text-white transition-colors whitespace-nowrap"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="rounded-xl bg-cinema-surface border border-white/10 p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-white/40">Tổng đơn đã thanh toán</p>
        ...
        <div className="rounded-xl bg-cinema-surface border border-white/10 p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-white/40">Tổng doanh thu</p>
      ...
      {filteredOrders.length === 0 ? (
        <div className="rounded-xl border border-white/10 bg-cinema-surface p-12 text-center">
          ...
          <p className="text-white/60">Chưa có đơn hàng đã thanh toán nào</p>
        ...
        <>
          <div className="rounded-xl overflow-hidden border border-white/10 bg-cinema-surface">
            <div className="overflow-x-auto">
              <table className="w-full min-w-[900px]">
                <thead className="border-b border-white/10 bg-black/10">
                  <tr>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-white/40 uppercase">
                      Mã đơn
                    </th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-white/40 uppercase">
                      Phim
...
>>>>>>> b42218c9d7389a8518f67d69301a5522196a19f0
                        ...
                        {order.seat_ids && order.seat_ids.length > 0 && (
                          <div className="text-white/40 text-xs mt-1 truncate max-w-[180px]">
                            ({formatSeatList(order.seat_ids).join(", ")})
                          </div>
                        )}
<<<<<<< HEAD
...
>>>>>>> b42218c9d7389a8518f67d69301a5522196a19f0
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="p-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-white/10 text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="mt-1 p-4 rounded-lg bg-black/10 border border-white/10">
                  ...
                  <div>
                    ...
                    <p className="text-white text-base mt-1">
                      {selectedOrder.seat_ids?.length > 0
                        ? formatSeatList(selectedOrder.seat_ids).join(", ")
                        : "Không có dữ liệu"}
                    </p>
              ...
              <div className="flex gap-3 mt-6">
                <button
                  onClick={() => setShowDetailModal(false)}
                  className="flex-1 py-2.5 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-white/10 text-white font-semibold transition-colors"
                >
                  Đóng
                </button>
              </div>

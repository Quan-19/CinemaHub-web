...
export default function ShowtimesPage() {
  ...
  const handleSave = async (formData) => {
    ...
    try {
      ...
      const endTime = calculateEndTime(formData.movieId, formData.time, formData.movieDuration);
  ...
  const updateFormFromSelection = (updates) => {
    setForm(prev => {
      ...
      if (updates.movieId && updates.movieDuration) {
        newForm.endTime = calculateEndTime(updates.movieId, newForm.time, updates.movieDuration);
      }
